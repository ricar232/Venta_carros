...
//
// Point these at your Node.js backend. Adjust API_BASE if your API isn't
// same-origin. Expected contract:
//
...
async function postJson(path, body) {
  ...
  try {
    ...
    throw new Error('No se pudo conectar con el servidor. Verifica tu backend de Node.js.');
  }
  let data = {};
  try {
    data = await res.json();
