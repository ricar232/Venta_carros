    ...
    >
      <div style={{ position: 'relative', height: 180, background: `linear-gradient(135deg,${car.g1},${car.g2})`, overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', top: 12, left: 12, display: 'flex', gap: 6, flexWrap: 'wrap', maxWidth: 'calc(100% - 90px)' }}>
          ...
          {car.verified && (
            ...
            >
              <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="oklch(0.16 0.014 265)" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ padding: '18px 20px 20px', display: 'flex', flexDirection: 'column', gap: 10, flex: 1 }}>
        <div>
          ...
          <p style={{ margin: '4px 0 0', fontFamily: "'Manrope', sans-serif", fontSize: 13, color: 'oklch(0.68 0.015 265)' }}>
            {car.year} · {car.mileageFmt} mi · {car.city}
          </p>
        </div>
        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
          <span style={{ fontFamily: "'Manrope', sans-serif", fontSize: 11, fontWeight: 600, color: 'oklch(0.75 0.02 265)', background: 'oklch(1 0 0 / 0.06)', padding: '4px 9px', borderRadius: 100 }}>
            {car.fuel}
          </span>
          <span style={{ fontFamily: "'Manrope', sans-serif", fontSize: 11, fontWeight: 600, color: 'oklch(0.75 0.02 265)', background: 'oklch(1 0 0 / 0.06)', padding: '4px 9px', borderRadius: 100 }}>
            {car.transmission}
        ...
        <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: 12, borderTop: '1px solid oklch(1 0 0 / 0.07)' }}>
          <span style={{ fontFamily: "'Instrument Serif', serif", fontStyle: 'italic', fontSize: 22, color: 'oklch(0.72 0.17 200)' }}>{car.priceFmt}</span>
          <span style={{ fontFamily: "'Manrope', sans-serif", fontSize: 13, fontWeight: 700, color: 'oklch(0.97 0.008 265)', display: 'flex', alignItems: 'center', gap: 4 }}>
